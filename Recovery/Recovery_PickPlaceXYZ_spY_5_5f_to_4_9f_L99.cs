...
{
    public sealed class Recovery_PickPlaceXYZ_spY_5_5f_to_4_9f_L99 : Recovery_PickPlaceXYZ
    {
        public Recovery_PickPlaceXYZ_spY_5_5f_to_4_9f_L99()
            : base(new PickPlaceXYZRecoveryDecision
            {
                ...
                {
                    new PickPlaceXYZGrabReleaseOperation(3.4f, 5.3f, 5f, 8.3f, 5.5f, 0.2f, true, false),
                    new PickPlaceXYZGrabReleaseOperation(3.1f, 4.4f, 10f, 3.1f, 3.8f, 10f, false, false),
                    new PickPlaceXYZGrabReleaseOperation(3.1f, 7.3f, 10f, 3.1f, 6.7f, 10f, false, false),
