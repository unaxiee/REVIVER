...
{
    public sealed class Recovery_PickPlaceXYZ_spX_8_3f_to_7_7f_L98 : Recovery_PickPlaceXYZ
    {
        public Recovery_PickPlaceXYZ_spX_8_3f_to_7_7f_L98()
            : base(new PickPlaceXYZRecoveryDecision
            {
                ...
                {
                    new PickPlaceXYZGrabReleaseOperation(3.1f, 4.7f, 5f, 8.3f, 5.5f, 0.2f, true, false),
                    new PickPlaceXYZGrabReleaseOperation(3.7f, 3.8f, 10f, 3.1f, 3.8f, 10f, false, false),
        ...
        // posX=3.100119, posY=5.3000793, posZ=4.999795
        // counter=3, exitBox=0
    }
}
