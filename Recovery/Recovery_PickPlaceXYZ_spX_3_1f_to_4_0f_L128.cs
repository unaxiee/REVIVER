...
{
    public sealed class Recovery_PickPlaceXYZ_spX_3_1f_to_4_0f_L128 : Recovery_PickPlaceXYZ
    {
        public Recovery_PickPlaceXYZ_spX_3_1f_to_4_0f_L128()
            : base(new PickPlaceXYZRecoveryDecision
            {
                ...
                {
                    new PickPlaceXYZGrabReleaseOperation(4f, 5.3f, 5f, 3.1f, 5.3f, 5f, true, true),
                },
        ...
        // grab=False, c=True
        // spX=4, spY=5.3, spZ=5
        // posX=4.0001006, posY=5.3000793, posZ=4.999609
        // counter=3, exitBox=0
    }
}
