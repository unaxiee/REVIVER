...
{
    public sealed class Recovery_PickPlaceXYZ_spX_8_3f_to_8_6f_L98 : Recovery_PickPlaceXYZ
    {
        public Recovery_PickPlaceXYZ_spX_8_3f_to_8_6f_L98()
            : base(new PickPlaceXYZRecoveryDecision
            {
                ...
                {
                    new PickPlaceXYZGrabReleaseOperation(3.1f, 5.6f, 5f, 8.3f, 5.5f, 0.2f, true, false),
                    new PickPlaceXYZGrabReleaseOperation(2.8f, 3.8f, 10f, 3.1f, 3.8f, 10f, false, false),
                    new PickPlaceXYZGrabReleaseOperation(2.8f, 6.7f, 10f, 3.1f, 6.7f, 10f, false, false),
        ...
        // posX=3.1001012, posY=5.3000793, posZ=4.999852
        // counter=3, exitBox=0
    }
}
