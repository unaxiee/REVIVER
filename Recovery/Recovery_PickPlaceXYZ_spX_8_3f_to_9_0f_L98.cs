...
{
    public sealed class Recovery_PickPlaceXYZ_spX_8_3f_to_9_0f_L98 : Recovery_PickPlaceXYZ
    {
        public Recovery_PickPlaceXYZ_spX_8_3f_to_9_0f_L98()
            : base(new PickPlaceXYZRecoveryDecision
            {
                ...
                {
                    new PickPlaceXYZGrabReleaseOperation(3.1f, 6f, 5f, 8.3f, 5.5f, 0.2f, true, false),
                    new PickPlaceXYZGrabReleaseOperation(2.4f, 3.8f, 10f, 3.1f, 3.8f, 10f, false, false),
                    new PickPlaceXYZGrabReleaseOperation(2.4f, 6.7f, 10f, 3.1f, 6.7f, 10f, false, false),
