...
{
    public sealed class Recovery_PickPlaceXYZ_spY_5_3f_to_6_0f_L129 : Recovery_PickPlaceXYZ
    {
        public Recovery_PickPlaceXYZ_spY_5_3f_to_6_0f_L129()
            : base(new PickPlaceXYZRecoveryDecision
            {
                ...
                {
                    new PickPlaceXYZGrabReleaseOperation(3.1f, 6f, 5f, 3.1f, 5.3f, 5f, true, true),
                },
        ...
        // grab=False, c=True
        // spX=3.1, spY=6, spZ=5
        // posX=3.1001012, posY=5.9999084, posZ=4.9998903
        // counter=3, exitBox=0
    }
}
