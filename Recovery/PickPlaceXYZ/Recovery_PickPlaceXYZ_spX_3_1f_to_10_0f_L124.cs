...
{
    public class Recovery_PickPlaceXYZ_spX_3_1f_to_10_0f_L124 : Controller
    {
        ...
        public Recovery_PickPlaceXYZ_spX_3_1f_to_10_0f_L124()
        {
            ...
            recoverySteps = new Func<bool>[]
            {
                ...
                () => recoveryLogicGrabDrop(8f, 5.5f, 0, true, 3.1f, 5.3f, 5f, true, false)
            };
        }
