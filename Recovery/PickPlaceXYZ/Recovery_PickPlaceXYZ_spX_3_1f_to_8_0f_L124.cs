...
{
    public class Recovery_PickPlaceXYZ_spX_3_1f_to_8_0f_L124 : Controller
    {
        ...
        public Recovery_PickPlaceXYZ_spX_3_1f_to_8_0f_L124()
        {
            ...
            {
                () => recoveryLogicDrop(3.1f, 5.3f, 5f, true),
                () => recoveryLogicRollerForward(),
                () => recoveryLogicBeltForward(),
                () => recoveryLogicGrabDrop(8.3f, 5.5f, 5.3f, false, 3.1f, 3.8f, 10f, false, true),
                () => recoveryLogicBeltForward(),
                () => recoveryLogicGrabDrop(8.3f, 5.5f, 5.3f, false, 3.1f, 6.7f, 10f, false, true),
            };
        }
