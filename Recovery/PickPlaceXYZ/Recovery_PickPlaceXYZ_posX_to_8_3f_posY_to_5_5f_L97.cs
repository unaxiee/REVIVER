...
{
    public class Recovery_PickPlaceXYZ_posX_to_8_3f_posY_to_5_5f_L97 : Controller
    {
        ...
        public Recovery_PickPlaceXYZ_posX_to_8_3f_posY_to_5_5f_L97()
        {
            ...
            {
                () => recoveryLogicRollerBack(),
                () => recoveryLogicRollerForward(),
                () => recoveryLogicGrabDrop(3.1f, 4.2f, 5f, true, 8.3f, 5.5f, 0.3f, false, false),
                () => recoveryLogicGrabDrop(3.8f, 3.8f, 10f, false, 3.1f, 3.8f, 10f, false, false),
                () => recoveryLogicGrabDrop(3.7f, 6.7f, 10f, false, 3.1f, 6.7f, 10f, false, false),
                () => recoveryLogicGrabDrop(8.3f, 5.5f, 0.3f, true, 3.1f, 5.3f, 5f, false, false),
            };
        }
