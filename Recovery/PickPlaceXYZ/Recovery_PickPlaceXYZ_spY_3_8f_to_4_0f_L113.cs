...
{
    public class Recovery_PickPlaceXYZ_spY_3_8f_to_4_0f_L113 : Controller
    {
        ...
        public Recovery_PickPlaceXYZ_spY_3_8f_to_4_0f_L113()
        {
            ...
            recoverySteps = new Func<bool>[]
            {
                ...
                () => recoveryLogicGrabDrop(3.1f, 5.3f, 5f, true, 8.3f, 5.5f, 0.3f, false, false),
                () => recoveryLogicGrabDrop(2.9f, 3.8f, 10f, false, 3.1f, 3.8f, 10f, false, false),
                () => recoveryLogicGrabDrop(2.5f, 6.8f, 10f, false, 3.1f, 6.7f, 10f, false, false),
