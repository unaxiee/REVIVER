...
{
    public class Recovery_PickPlaceXYZ_grabState_State0_to_State1_L83 : Controller
    {
        ...
        public Recovery_PickPlaceXYZ_grabState_State0_to_State1_L83()
        {
            ...
            recoverySteps = new Func<bool>[]
            {
                ...
                () => recoveryLogicGrabDrop(3.1f, 5.3f, 5f, true, 8f, 5.5f, 0.3f, false, false),
                () => recoveryLogicGrabDrop(4.0f, 3.8f, 10f, false, 3.1f, 3.8f, 10f, false, false),
                () => recoveryLogicGrabDrop(3.8f, 6.7f, 10f, false, 3.1f, 6.7f, 10f, false, false),
