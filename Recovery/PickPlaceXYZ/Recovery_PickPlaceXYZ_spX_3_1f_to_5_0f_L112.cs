...
{
    public class Recovery_PickPlaceXYZ_spX_3_1f_to_5_0f_L112 : Controller
    {
        ...
        public Recovery_PickPlaceXYZ_spX_3_1f_to_5_0f_L112()
        {
            ...
            {
                () => recoveryLogic(3.1f, 5.3f, 5f, true, 8.3f, 5.5f, 0.3f, false),
                () => recoveryLogic(5.0f, 3.8f, 10f, false, 3.1f, 3.8f, 10f, false),
                () => recoveryLogic(8.3f, 5.5f, 0.3f, false, 3.1f, 5.3f, 5f, true)
            };
        }
        ...
        private bool recoveryLogic(float curr_spX, float curr_spY, float curr_spZ, bool grab_c, float tar_spX, float tar_spY, float tar_spZ, bool drop_c)
        {
