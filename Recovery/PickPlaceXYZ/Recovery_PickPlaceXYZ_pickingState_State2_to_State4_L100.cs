...
{
    public class Recovery_PickPlaceXYZ_pickingState_State2_to_State4_L100 : Controller
    {
        ...
        State pickingState = State.State2;
        State grabState = State.State3;
        ...
        public Recovery_PickPlaceXYZ_pickingState_State2_to_State4_L100()
        {
