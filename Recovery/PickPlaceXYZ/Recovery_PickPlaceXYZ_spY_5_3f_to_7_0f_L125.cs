...
{
    public class Recovery_PickPlaceXYZ_spY_5_3f_to_7_0f_L125 : Controller
    {
        ...
        public Recovery_PickPlaceXYZ_spY_5_3f_to_7_0f_L125()
        {
        ...
        private void recoveryLogic()
        {
            ...
            {
                spY.Value = 5.3f;
                if (Near(spY.Value, posY.Value, 0.01f))
                {
