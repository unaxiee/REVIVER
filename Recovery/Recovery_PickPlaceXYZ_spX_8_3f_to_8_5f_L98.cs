...
{
    public sealed class Recovery_PickPlaceXYZ_spX_8_3f_to_8_5f_L98 : Recovery_PickPlaceXYZ
    {
        public Recovery_PickPlaceXYZ_spX_8_3f_to_8_5f_L98()
            : base(new PickPlaceXYZRecoveryDecision
            {
                ...
                {
                    new PickPlaceXYZGrabReleaseOperation(3.1f, 5.5f, 5f, 8.3f, 5.5f, 0.2f, true, false),
                    new PickPlaceXYZGrabReleaseOperation(2.9f, 3.8f, 10f, 3.1f, 3.8f, 10f, false, false),
                    new PickPlaceXYZGrabReleaseOperation(2.9f, 6.7f, 10f, 3.1f, 6.7f, 10f, false, false),
