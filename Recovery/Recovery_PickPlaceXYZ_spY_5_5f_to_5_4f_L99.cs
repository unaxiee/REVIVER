...
{
    public sealed class Recovery_PickPlaceXYZ_spY_5_5f_to_5_4f_L99 : Recovery_PickPlaceXYZ
    {
        public Recovery_PickPlaceXYZ_spY_5_5f_to_5_4f_L99()
            : base(new PickPlaceXYZRecoveryDecision
            {
                ...
                {
                    new PickPlaceXYZGrabReleaseOperation(3.15f, 5.3f, 5f, 8.3f, 5.5f, 0.2f, true, false),
                    new PickPlaceXYZGrabReleaseOperation(3.1f, 3.9f, 10f, 3.1f, 3.8f, 10f, false, false),
                    new PickPlaceXYZGrabReleaseOperation(3.1f, 6.8f, 10f, 3.1f, 6.7f, 10f, false, false),
        ...
        // posX=3.1001012, posY=5.3000793, posZ=4.999776
        // counter=3, exitBox=0
    }
}
