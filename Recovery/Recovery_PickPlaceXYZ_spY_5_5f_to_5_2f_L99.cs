...
{
    public sealed class Recovery_PickPlaceXYZ_spY_5_5f_to_5_2f_L99 : Recovery_PickPlaceXYZ
    {
        public Recovery_PickPlaceXYZ_spY_5_5f_to_5_2f_L99()
            : base(new PickPlaceXYZRecoveryDecision
            {
                ...
                {
                    new PickPlaceXYZGrabReleaseOperation(3.25f, 5.3f, 5f, 8.3f, 5.5f, 0.2f, true, false),
                    new PickPlaceXYZGrabReleaseOperation(3.1f, 4.1f, 10f, 3.1f, 3.8f, 10f, false, false),
        ...
        // posX=3.1001012, posY=5.2999115, posZ=4.9998903
        // counter=3, exitBox=0
    }
}
