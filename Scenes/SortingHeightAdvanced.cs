...
namespace Controllers
{
    public class SortingHeightAdvanced : Controller
    {
        ...
        public override void Execute(int elapsedMilliseconds)
        {
            ...
            // Output
            // Update in a specific cycle -> negate in this cycle
            // Right conveyor
            if (rtAtRightEntry.Q)
            {
                rightConveyor.Value = true;
                //rightConveyor.Value = !rightConveyor.Value;
            }
            ...
            if (rtAtLeftEntry.Q)
            {
                ...
                //leftConveyor.Value = !leftConveyor.Value;
            }
            ...
            // Output
            // Update every cycle -> negate every cycle
            //feederConveyor.Value = !feederConveyor.Value;
            //entryConveyor.Value = !entryConveyor.Value;
