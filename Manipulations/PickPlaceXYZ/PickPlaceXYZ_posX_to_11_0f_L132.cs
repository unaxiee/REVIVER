...
{
    public class PickPlaceXYZ_posX_to_11_0f_L132 : Controller
    {
        ...
        public PickPlaceXYZ_posX_to_11_0f_L132()
        {
        ...
        public override void Execute(int elapsedMilliseconds)
        {
            ...
            else if (pickingState == State.State3)
            {
                ...
                if (Near(11.0f, spX.Value, 0.01f) && Near(posY.Value, spY.Value, 0.01f))
