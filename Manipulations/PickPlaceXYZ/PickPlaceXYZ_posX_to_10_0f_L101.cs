...
{
    public class PickPlaceXYZ_posX_to_10_0f_L101 : Controller
    {
        ...
        public PickPlaceXYZ_posX_to_10_0f_L101()
        {
        ...
        public override void Execute(int elapsedMilliseconds)
        {
            ...
            else if (pickingState == State.State1)
            {
                ...
                if (Near(10.0f, spX.Value, 0.01f) && Near(posY.Value, spY.Value, 0.01f))
                {
