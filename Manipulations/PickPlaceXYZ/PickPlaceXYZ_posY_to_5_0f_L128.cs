...
{
    public class PickPlaceXYZ_posY_to_5_0f_L128 : Controller
    {
        ...
        public PickPlaceXYZ_posY_to_5_0f_L128()
        {
        ...
        public override void Execute(int elapsedMilliseconds)
        {
            ...
            else if (pickingState == State.State3)
            {
                ...
                if (Near(posX.Value, spX.Value, 0.01f) && Near(5.0f, spY.Value, 0.01f))
