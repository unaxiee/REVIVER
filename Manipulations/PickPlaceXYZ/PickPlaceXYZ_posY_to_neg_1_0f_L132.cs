...
{
    public class PickPlaceXYZ_posY_to_neg_1_0f_L132 : Controller
    {
        ...
        public PickPlaceXYZ_posY_to_neg_1_0f_L132()
        {
        ...
        public override void Execute(int elapsedMilliseconds)
        {
            ...
            else if (pickingState == State.State3)
            {
                ...
                if (Near(posX.Value, spX.Value, 0.01f) && Near(-1.0f, spY.Value, 0.01f))
