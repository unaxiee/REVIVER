...
{
    public class PickPlaceXYZ_posX_to_8_3f_posY_to_5_5f_L128 : Controller
    {
        ...
        public PickPlaceXYZ_posX_to_8_3f_posY_to_5_5f_L128()
        {
        ...
        public override void Execute(int elapsedMilliseconds)
        {
            ...
            else if (pickingState == State.State1)
            {
                ...
                if (Near(8.3f, spX.Value, 0.01f) && Near(5.5f, spY.Value, 0.01f))
                {
