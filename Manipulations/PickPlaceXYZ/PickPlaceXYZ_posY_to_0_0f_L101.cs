...
{
    public class PickPlaceXYZ_posY_to_0_0f_L101 : Controller
    {
        ...
        public PickPlaceXYZ_posY_to_0_0f_L101()
        {
        ...
        public override void Execute(int elapsedMilliseconds)
        {
            ...
            else if (pickingState == State.State1)
            {
                ...
                if (Near(posX.Value, spX.Value, 0.01f) && Near(0.0f, spY.Value, 0.01f))
                {
