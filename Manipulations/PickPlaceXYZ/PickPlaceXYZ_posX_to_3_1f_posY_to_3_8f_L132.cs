...
{
    public class PickPlaceXYZ_posX_to_3_1f_posY_to_3_8f_L132 : Controller
    {
        ...
        public PickPlaceXYZ_posX_to_3_1f_posY_to_3_8f_L132()
        {
        ...
        public override void Execute(int elapsedMilliseconds)
        {
            ...
            else if (pickingState == State.State3)
            {
                ...
                if (Near(3.1f, spX.Value, 0.01f) && Near(3.8f, spY.Value, 0.01f))
